...
export function CreateCalendarDialog({
  ...
  // Trạng thái để kiểm soát việc hiển thị danh sách thời gian
  const [isStartTimeOpen, setIsStartTimeOpen] = useState(false);
  const [isEndTimeOpen, setIsEndTimeOpen] = useState(false);
  const [isReminderTimeOpen, setIsReminderTimeOpen] = useState(false);

  // Cập nhật thời gian nhắc nhở khi startTime thay đổi
  useEffect(() => {
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <ChevronDown
                    ...
                    onClick={() => setIsReminderTimeOpen(!isReminderTimeOpen)}
                  />
                  {isReminderTimeOpen && (
